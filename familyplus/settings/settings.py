"""
Django settings for familyplus project.
...
# Enforce DEBUG via env and default to False in case env not set
DEBUG = config('DEBUG', default=False, cast=bool)

# ALLOWED_HOSTS: keep in env, comma-separated; don't use ['*'] in production
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.newsletter_form',
            ],
        },
    },
]
